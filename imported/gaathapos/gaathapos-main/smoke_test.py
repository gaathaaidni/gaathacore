...
# By default we skip these smoke tests when running under pytest because they require a running server.
# Set RUN_SMOKE_TESTS=1 in the environment to enable (or run this file directly via python).
import os
