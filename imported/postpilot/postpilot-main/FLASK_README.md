...
- **Multi-Post Management**: Manage posts for Tour (Nexora Suite), NZ/Visa (Phoenix), Gaatha AI, and Instagram
- **Facebook Integration**: Automatically post to Facebook using Graph API
- **Instagram Sync**: Sync Facebook posts to Instagram
- **News Automation**: Grahak Chetna RSS to Video/Image automation
- **Video Factory**: Generate and post Reels/Videos from text for Grahak Chetna
